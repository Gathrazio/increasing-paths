...
*/
const checkElement = (direction, grid, row, column, currentElement, adjacentElement) => {
...
const recursiveDetermination = (grid, row, column) => {
...
const findIncreasingPaths = (grid) => {
    let runningTotal = 0;
...
//# sourceMappingURL=increasingPaths.js.map